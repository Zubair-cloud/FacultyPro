    ...
    renderHomeList() {
        ...
        this.classes.forEach(c => {
            ...
            div.innerHTML = `
                ...
                <button class="size-10 rounded-xl bg-primary flex items-center justify-center text-[var(--on-primary)] shadow-lg shadow-[var(--primary-dim)] transition-transform hover:scale-110">
